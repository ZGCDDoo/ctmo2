...
TEST(ABC_H0_Tests, Init)
{
    ...
    {   "NOrb": 2,
        ...
        "tParameters": 
            {"00": 
                {"tIntra": 0.0, "tx": 1.0, "ty": 1.08, "tz": 0.0,  "tx=y": 1.07, "tx=-y": 1.06, "tx=z": 0.0, "tx=-z": 0.0, "ty=z": 0.0, "ty=-z": 0.0, "t2x" : 1.05, "t2y": 1.04, "t2z": 0.0},
            "01":
                {"tIntra": -100.0, "tx": 1.10, "ty": 1.09, "tz": 0.0, "tx=y": 1.04, "tx=-y": 1.03, "tx=z": 0.0, "tx=-z": 0.0, "ty=z": 0.0, "ty=-z": 0.0, "t2x" : 1.02, "t2y": 1.01, "t2z": 0.0},
            "11":
                {"tIntra": 0.201, "tx": -1.01, "ty": 1.01, "tz":0.0, "tx=y": 1.02, "tx=-y": 1.03, "tx=z": 0.0, "tx=-z": 0.0, "ty=z": 0.0, "ty=-z": 0.0, "t2x" : -1.04, "t2y": 1.09, "t2z": 0.0}
